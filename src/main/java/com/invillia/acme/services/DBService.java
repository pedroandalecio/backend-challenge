...
import com.invillia.acme.enums.Perfil;
import com.invillia.acme.enums.StatusPedido;
import com.invillia.acme.enums.TipoCliente;
...
import com.invillia.acme.model.PagamentoComCartao;
...
import com.invillia.acme.repository.EnderecoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Loja loja = new Loja(null, "Empresa PH Ltda", "Rua viana, nº 45, Santo Amaro/BA");
		...
		Cliente cli2 = new Cliente(null, "Ana Costa", "ana.iftm@gmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
		...
		Pedido ped1 = new Pedido(null, sdf.parse("30/09/2017 10:32"), cli1, e1, StatusPedido.Emitido);
		Pedido ped2 = new Pedido(null, sdf.parse("10/10/2017 19:35"), cli1, e2, StatusPedido.Emitido);
